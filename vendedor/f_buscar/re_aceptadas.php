...
$salida ="";
$query ="select r.id_reserva,c.rut,c.nombres,c.apellidos,c.telefono,v.patente,r.fecha_reserv,r.Hora from reserva r,cliente c,vehiculo v where c.id_cliente = r.id_cliente and r.id_reserva =v.id_vehiculo and r.estado_reserva=2";
